...
// Asset imports
import placeholder from '../../assets/not-found-placeholder.jpeg';
...
const Movie: React.FC<MovieProps> = ({ movie, viewTrailer, closeCard }) => {
    ...
    const myClickHandler = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        ...
        target.parentElement?.parentElement?.classList.remove('opened');
    };
            ...
            <div className="card" onClick={(e) => e.currentTarget.classList.add('opened')} >
                <div className="card-body text-center">
                    ...
                    <div className="info_panel">
                        ...
                        {!starred.starredMovies.map((movie: IMovie) => movie.id).includes(movie.id) ? (
                        ...
                        {!watchLater.watchLaterMovies.map((movie: IMovie) => movie.id).includes(movie.id) ? (
